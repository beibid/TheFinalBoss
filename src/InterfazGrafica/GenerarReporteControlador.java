    ...
    public class GenerarReporteControlador {
        ...
        @FXML private TextArea textoAreaActividadesSemanaUno;
        @FXML private TextArea textoAreaActividadesSemanaDos;
        @FXML private TextArea textoAreaActividadesSemanaTres;
        @FXML private TextArea textoAreaActividadesSemanaCuatro;
        ...
        private boolean camposValidos() {
            ...
            String actividadesSemanaUno = textoAreaActividadesSemanaUno.getText().trim();
        ...
        private void generarPdf() {
            String actividades = "Semana 1: " + textoAreaActividadesSemanaUno.getText().trim() +
                    "\nSemana 2: " + textoAreaActividadesSemanaDos.getText().trim() +
